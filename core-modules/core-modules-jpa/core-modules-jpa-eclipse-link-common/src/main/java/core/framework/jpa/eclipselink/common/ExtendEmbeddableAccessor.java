 ...
 * @author ebin
 */
public class ExtendEmbeddableAccessor extends EmbeddableAccessor {
    public ExtendEmbeddableAccessor() {
    }

    public ExtendEmbeddableAccessor(MetadataAnnotation annotation, MetadataClass cls, MetadataProject project) {

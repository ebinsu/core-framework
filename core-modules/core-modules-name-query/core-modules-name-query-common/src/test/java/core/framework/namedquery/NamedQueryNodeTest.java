...
public class NamedQueryNodeTest {
    ...
    public void test_text_node() {
        ...
        NamedQueryContext context = new NamedQueryContext(Map.of("name", NAME_VARIABLE), Map.of());
    ...
    public void test_if_node_condition_no_pass() {
        ...
        IfNode ifNode = new IfNode(List.of(textNode), "name!=null");
        NamedQueryContext context = new NamedQueryContext(Map.of(), Map.of());
        ifNode.apply(context);
    ...
    public void test_foreach_node() {
        ...
        NamedQueryContext context = new NamedQueryContext(Map.of("col", List.of("a", "b", "c")), Map.of());
    ...
    public void test_include_node() {
        TextNode textNode = new TextNode("${name}");
        IfNode ifNode = new IfNode(List.of(textNode), "name!=null");
        FragmentNode fragmentNode = new FragmentNode("f1", List.of(ifNode));

        IncludeNode includeNode = new IncludeNode("f1");
        StaticTextNode and = new StaticTextNode("and");
        SqlNode sqlNode = new SqlNode("1", Object.class, List.of(includeNode, and, ifNode));
        NamedQueryContext context = new NamedQueryContext(Map.of("name", NAME_VARIABLE), Map.of("f1", fragmentNode));

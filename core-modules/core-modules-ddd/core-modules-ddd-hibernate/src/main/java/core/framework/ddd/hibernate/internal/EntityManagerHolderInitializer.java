 ...
 * @author ebin
 */
public class EntityManagerHolderInitializer implements ApplicationListener<ContextRefreshedEvent> {
    @Override
    ...
    private void initializeDomainEventTrackingPersistentUnitHolder(ApplicationContext applicationContext) {
        ...
        EntityManagerHolder.INSTANCE.setManagerFactories(entityManagerFactories.values());
    }
}

 ...
 * @author ebin
 */
public class AggregateRootBeforeDeleteEvent extends MongoMappingEvent<AggregateRoot> {
     ...
     */
    public AggregateRootBeforeDeleteEvent(AggregateRoot source, Document document, String collectionName) {

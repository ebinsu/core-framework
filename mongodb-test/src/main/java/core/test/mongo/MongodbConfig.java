...
public class MongodbConfig {
    ...
    public ConfigurablePersistenceUnitInfo mongodbPersistenceUnitInfo() {
        ...
        properties.put("eclipselink.session-event-listener", MySessionEventListener.class.getName());
...
//        properties.putIfAbsent(AvailableSettings.JPA_VALIDATION_MODE, ValidationMode.AUTO);
        ...
        configurablePersistenceUnitInfo.setPersistenceProviderClassName(MyPersistenceProvider.class.getName());
